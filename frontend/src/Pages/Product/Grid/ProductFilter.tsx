...
const Productfilter = ({ name, setSelect }: any) => {
    ...
    const handleDic = (event: any) => {
        ...
        product?.filter((discount: any) => console.log("dicount", discount.dic, event.value))
    }
                                    ...
                                    <div className="accordion-collapse collapse show" aria-labelledby="flush-headingDiscount">
                                        <div className="accordion-body text-body pt-1">
                                            <div className="d-flex flex-column gap-2 filter-check" id="discount-filter">
                                                <div className="form-check">
                                                    <Form.Control className="form-check-input" type="checkbox" value="50" id="productdiscountRadio6" onClick={(e: any) => handleDic(e.target)} />
                                                    <Form.Label className="form-check-label" htmlFor="productdiscountRadio6">50% or more</Form.Label>
                                                </div>
                                                <div className="form-check">
                                                    <Form.Control className="form-check-input" type="checkbox" value="40" id="productdiscountRadio5" onClick={(e: any) => handleDic(e.target)} />
                                                    <Form.Label className="form-check-label" htmlFor="productdiscountRadio5">40% or more</Form.Label>
                                                </div>
                                                <div className="form-check">
                                                    <Form.Control className="form-check-input" type="checkbox" value="30" id="productdiscountRadio4" onClick={(e: any) => handleDic(e.target)} />
                                                    <Form.Label className="form-check-label" htmlFor="productdiscountRadio4">
                                                        30% or more
                                                    </Form.Label>
                                                </div>
                                                <div className="form-check">
                                                    <Form.Control className="form-check-input" type="checkbox" value="20" id="productdiscountRadio3" onClick={(e: any) => handleDic(e.target)} />
                                                    <Form.Label className="form-check-label" htmlFor="productdiscountRadio3">
                                                        20% or more
                                                    </Form.Label>
                                                </div>
                                                <div className="form-check">
                                                    <Form.Control className="form-check-input" type="checkbox" value="10" id="productdiscountRadio2" onClick={(e: any) => handleDic(e.target)} />
                                                    <Form.Label className="form-check-label" htmlFor="productdiscountRadio2">
                                                        10% or more
                                                    </Form.Label>
                                                </div>
                                                <div className="form-check">
                                                    <Form.Control className="form-check-input" type="checkbox" value="0" id="productdiscountRadio1" onClick={(e: any) => handleDic(e.target)} />
