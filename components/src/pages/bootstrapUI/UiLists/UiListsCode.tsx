...
const ListCheckboxsExample = () => (
    <PrismCode
        code={listCheckboxsCode}
        language={("js")}
        plugins={["line-numbers"]}
    />
);
