...
const BasicColumn = ({ dataColors }:any) => {
  ...
  return (
      <Chart dir="ltr" className="apex-charts"
          series={series}
          options={options}
          type="bar"
          height={350}
...
const ColumnWithLable = ({ dataColors }:any) => {
  ...
  return (
      <Chart dir="ltr" className="apex-charts" series={series} options={options} type="bar" height={350} />
  );
};
...
const ColumnMarker = ({ dataColors }:any) => {
  ...
  return (
      <Chart dir="ltr" className="apex-charts" options={options} series={series} type="bar" height={350} />
  );
};
...
const DynamicColumn = ({ dataColors }:any) => {
  ...
  return <Chart dir="ltr" className="apex-charts" series={series} options={options} type="bar" height={330} />;
};
