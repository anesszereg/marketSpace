...
const SearchModal = () => {
    ...
    return (
        <React.Fragment>
            <button type="button" onClick={handleToggleModal} className="btn btn-sm px-3 fs-15 user-name-text header-item d-none d-md-block">
                ...
                <div className="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 overflow-hidden" ref={searchDropdown} id="search-dropdown">
                    ...
                    <div className="dropdown-head rounded-top">
                        ...
                        <div className="dropdown-item bg-transparent text-wrap">
                            <a href="index.html" className="btn btn-soft-secondary btn-sm btn-rounded">how to setup <i className="mdi mdi-magnify ms-1 align-middle"></i></a>
                            <a href="index.html" className="btn btn-soft-secondary btn-sm btn-rounded">buttons <i className="mdi mdi-magnify ms-1 align-middle"></i></a>
                        </div>
                    </div>
