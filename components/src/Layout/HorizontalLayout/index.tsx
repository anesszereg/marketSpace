                        ...
                        {!item['isHeader'] ?
                            (item.subItems ? (
                                <li className="nav-item">
                                    ...
                                    <Collapse
                                        className={item.id === "baseUi" && item.subItems.length > 8 ? "menu-dropdown mega-dropdown-menu" : "menu-dropdown"} in={item.stateVariables}>
                                        {/* subItms  */}
                                        {item.id === "baseUi" && item.subItems.length > 8 ? (
                                            <React.Fragment>
                                                <Row id="sidebarApps">
