                        ...
                        <div className="p-2">
                            <div className="text-center empty-cart" ref={emptyCart} style={{ display: "none" }}>
                                <div className="avatar-md mx-auto my-3">
                                    <div className="avatar-title bg-soft-info fs-36 rounded-circle">
                            ...
                            {cartData.map((item, key) => (
                                <div className="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2" key={key}>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="ps-2">
                                            <Button variant='ghost-secondary' type="button" className="btn-icon btn-ghost-secondary remove-item-btn" onClick={(e) => { removeItem(e.target); }}><i
